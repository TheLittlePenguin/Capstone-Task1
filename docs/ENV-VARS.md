...
| `TEST_BASE_URL` | No | Yes | URL for Playwright E2E tests (`http://localhost:3000` locally) |
| `TEST_EMAIL` | No | Yes | Email to use for E2E tests |
| `TEST_PASSWORD` | **Yes** | Yes | Password to use for E2E tests |
