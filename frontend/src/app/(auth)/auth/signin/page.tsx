...
export default function SignInPage() {
  ...
  return (
    <div className="flex border-3 -m-1 rounded-md flex-col sm:flex-row overflow-hidden">
      <div className="space-y-1 text-center sm:w-1/3 bg-gray-200 dark:bg-zinc-800 overflow-hidden ">
        <img className="w-full h-24 sm:h-108 object-cover rounded-tl-md"></img>
        <div className="space-y-5 p-5 text-left" >
          <h1 className="text-2xl font-bold tracking-tight">Welcome back</h1>
          <p className="text-sm text-zinc-500">Log in to continue to your account and access your dashboard</p>
        </div>
      </div>

      <div className="sm:border-l-3 space-y-10 p-10 text-center sm:w-2/3">
        <div className="flex flex-col items-center">
          <img className="h-15 w-15"></img>
          <p>Brand</p>
        </div>
        <div className="space-y-1">
          <h1 className="text-2xl text-center font-bold">Log in to your account</h1>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-zinc-50 px-2 text-zinc-400 dark:bg-zinc-950">or continue with</span>
          </div>
        </div>
        <button
          type="button"
